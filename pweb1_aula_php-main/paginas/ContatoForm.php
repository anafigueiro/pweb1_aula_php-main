...
<body>
    <form action="ContatoForm.php" method="post">
        ...
        <input type="text" name="email" id=""><?php echo(!empty($data->email)? $data->email : "")?><br>

        <label for="">Telefone</label>
        <input type="text" name="telefone" id=""><?php echo(!empty($data->telefone)? $data->telefone : "")?><br>

        <button type="submit" value="Enviar"><?php echo(empty($_GET['id'])? "Salvar" : "Atualizar")?></button><br>
